...
def measure_data_transfer_rate(camera, duration=10):
    camera.Init()
    ...
    data_rate = total_data_transferred / elapsed_time / (1024 * 1024)
...
try:
    frame_count, data_rate, elapsed_time = measure_data_transfer_rate(camera)
    print(f"Captured {frame_count} frames in {elapsed_time:.2f} seconds at higher resolution.")
